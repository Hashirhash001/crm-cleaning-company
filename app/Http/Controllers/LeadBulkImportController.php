...
class LeadBulkImportController extends Controller
{
    ...
    private function getServiceMapping()
    {
        return [
            ...
            'HOME THEATER CLEANING' => 'Home Theatre Cleaning',
            'HOME THEATER' => 'Home Theatre Cleaning',
            'HOME THEATER CLEAN' => 'Home Theatre Cleaning',
            'WINDOW CLEANING' => 'Window Cleaning',
            'WINDOW' => 'Window Cleaning',
            'WINDOW CLEAN' => 'Window Cleaning',
            'CHAIR SHAMPOOING' => 'Chair Shampooing',
            'CHAIR SHAMPOO' => 'Chair Shampooing',
            'ROOF TOP' => 'Roof Top Cleaning',
            'ROOF CLEANING' => 'Roof Top Cleaning',
            'ROOF' => 'Roof Top Cleaning',
            'Pantry cleaning' => 'Pantry Cleaning',
            'PANTRY CLEANING' => 'Pantry Cleaning',
            'PANTRY' => 'Pantry Cleaning',
            'Pantry' => 'Pantry Cleaning',
