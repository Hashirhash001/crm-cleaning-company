...
<style>
    ...
    .whatsapp-header { background: linear-gradient(135deg, #25D366 0%, #128C7E 100%); }
        ...
        <div class="col-sm-12">
            <div class="page-title-box">
                <div class="row">
                    <div class="col">
                        <h4 class="page-title">
                            <i class="lab la-whatsapp me-2" style="font-size: 1.5rem; color: #25D366;"></i>
                            WhatsApp Leads
                        </h4>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('leads.index') }}">Leads</a></li>
                            <li class="breadcrumb-item active">WhatsApp Leads</li>
                        </ol>
                    </div>
            ...
            <div class="card">
                <div class="card-header whatsapp-header">
                    <h5 class="card-title text-white mb-0">
                        <i class="las la-filter me-2"></i>Filter WhatsApp Leads
                    </h5>
                </div>
                <div class="card-body" style="padding: 20px;">
                    <form method="GET" action="{{ route('leads.whatsapp') }}" id="filterForm">
            ...
            <div class="card leads-card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="card-title mb-0">
                        <i class="lab la-whatsapp me-2 text-success"></i>
                        WhatsApp Leads List
                    </h4>
                </div>
                <div class="card-body">
...
$(document).ready(function() {
    ...
    $('#resetBtn').on('click', function() {
        ...
        $('#dateToFilter').val('');
        $('#searchInput').val('');
        window.location.href = "{{ route('leads.whatsapp') }}";
    });

    // Load leads via AJAX
    function loadLeads(url = null) {
        let formData = $('#filterForm').serialize();
        let requestUrl = url || "{{ route('leads.whatsapp') }}";
